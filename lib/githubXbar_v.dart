...
//
//     if (_subgroupSize == 1) {
//       // For Sample Size 1, we should calculate moving averages
//       // of consecutive pairs like X1&X2, X2&X3, etc.
//       return List<double>.generate(
//         widget.data.length - 1,
//             (i) => (widget.data[i] + widget.data[i + 1]) / 2,
//       );
//     }
//
...
//
//       if (subgroup.length == _subgroupSize) {
...
//     switch(sampleSize) {
//       case 1: return widget.data.length - 1;  // Moving pairs
//       case 2: return 5;  // 5 groups of 2
//       case 3: return 3;  // 3 groups of 3
//       case 4: return 3;  // 3 groups of 4
//       case 5: return 2;  // 2 groups of 5
//       default: return 0;
//     }
//   }
//
...
//       // Calculate ranges between consecutive points
//       return List<double>.generate(
//         widget.data.length - 1,
//             (i) => (widget.data[i + 1] - widget.data[i]).abs(),
//       );
//     } else {
//       // Existing logic for sample sizes 2-5
//       final numberOfGroups = (widget.data.length / _subgroupSize).floor();
//       return List<double>.generate(
//         numberOfGroups,
//             (i) {
...
//     final minMeaningfulInterval = range / 100;  // Changed from 1000 to 100
